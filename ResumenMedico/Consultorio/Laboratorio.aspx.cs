...
namespace ResumenMedico.Consultorio
{
	public partial class Laboratorio : BasePage
	{
		...
		protected void Page_Load(object sender, EventArgs e)
		{
			...
			{
				if (!(this.PerfilActual == Constants.Perfiles.Laboratorio || this.IsAdmin))
				{
				...
				else
				{
					if (!IsPostBack)
					{
						...
						if (this.PerfilActual != Constants.Perfiles.Laboratorio)
						{
							...
							rbtnUrologia.Visible = false;
							rbtnLoadFileUro.Visible = false;
							rbtnEliminarUro.Visible = false;
							rbtnGuardarVIH.Visible = false;
							rbtnLoadFileVih.Visible = false;
							rbtnEliminarVih.Visible = false;
							rbtnGuardarSerologia.Visible = false;
							rbtnLoadFileSero.Visible = false;
							rbtnEliminarSerologia.Visible = false;
							rbtnHepB.Visible = false;
							rbtnLoadFileHepaB.Visible = false;
							rbtnEliminarHepB.Visible = false;
							rbtnHepC.Visible = false;
							rbtnLoadFileHepaC.Visible = false;
							rbtnEliminarHepC.Visible = false;
							rbtnCuadroHematico.Visible = false;
							rbtnLoadFileCH.Visible = false;
							rbtnEliminarCuadroHematico.Visible = false;
							rbtnCreatinina.Visible = false;
							rbtnLoadFileCre.Visible = false;
							rbtnEliminarCreatinina.Visible = false;
							rbtnHemGli.Visible = false;
							rbtnLoadFileHemGli.Visible = false;
							rbtnEliminarHemGli.Visible = false;
							rbtnOtroGuardar.Visible = false;
							rbtnLoadFileOtro.Visible = false;
							rbtnEliminarOtro.Visible = false;
							rbtnAddCultivo.Visible = false;
							rbtnAddFileCult.Visible = false;
							rbtnEliminarCultivo.Visible = false;
							rbtnAddBaciloscopia.Visible = false;
							rbtnAddFileBacilo.Visible = false;
							rbtnEliminarBacilo.Visible = false;
						}
		...
		protected void rbtnOtroGuardar_Click(object sender, EventArgs e)
		{
			...
			{
				string scriptcontent = string.Format("alert('{0}')", ex.ToString());
