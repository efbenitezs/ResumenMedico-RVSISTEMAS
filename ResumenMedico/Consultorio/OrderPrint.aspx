    ...
    <body>
        <form id="form1" runat="server">
            ...
            <div style="margin: 0 auto; background-color: White;">
                ...
                <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4">
                    <b>Ref: <asp:Label ID="lblNomPac" runat="server"></asp:Label></b>
                </div>
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">&nbsp;</div>
                <div class="col-lg-2 col-md-2 col-sm-2 col-xs-2">&nbsp;</div>
                <div class="col-lg-8 col-md-8 col-sm-8 col-xs-8">
                    Por motivos de migración a <asp:Label ID="lblEmbajada" runat="server"></asp:Label> se requiere concepto de <asp:label ID="lblMedtrantante" runat="server"></asp:label> que indique:
                </div>
                <div class="col-lg-2 col-md-2 col-sm-2 col-xs-2">&nbsp;</div>
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">&nbsp;</div>
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <center><asp:Label ID="lblinfoOrden" runat="server"></asp:Label></center>
                </div>
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">&nbsp;</div>
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">&nbsp;</div>
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">&nbsp;</div>
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">&nbsp;</div>
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <center><telerik:RadButton ID="rbtnImp" runat="server" Text="imprimir" OnClientClicking="Imprimir"></telerik:RadButton></center>
                </div>
            </div>
