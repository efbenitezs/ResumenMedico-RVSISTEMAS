<%@ Page Title="" Language="C#" MasterPageFile="~/Reportes/Reportes.master" AutoEventWireup="true"
	CodeBehind="ListaPacientesPendLab.aspx.cs" Inherits="ResumenMedico.Reportes.ListaPacientesPendLab" %>
...
<asp:Content ID="cBody" ContentPlaceHolderID="cphBodyMaster" runat="server">
	...
	<div class="row">
		<div class="titulo">
			Listado Pacientes Pendientes Laboratorio
		</div>
		<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
			<telerik:RadGrid ID="rgData" runat="server" AutoGenerateColumns="false" PageSize="20"
				...
				<MasterTableView CommandItemDisplay="None" Font-Names="verdana">
					<Columns>
						...
						<telerik:GridHyperLinkColumn HeaderText="" DataNavigateUrlFields="ID" DataNavigateUrlFormatString="../Consultorio/Laboratorio.aspx?IdHist={0}"
