<%@ Page Title="" Language="C#" MasterPageFile="~/Reportes/Reportes.master" AutoEventWireup="true"
	CodeBehind="ListaPacientesPendMed.aspx.cs" Inherits="ResumenMedico.Reportes.ListaPacientesPendMed" %>
			...
			<telerik:RadGrid ID="rgData" runat="server" AutoGenerateColumns="false" PageSize="20"
				...
				<MasterTableView CommandItemDisplay="None" Font-Names="verdana">
					<Columns>
						...
						<telerik:GridHyperLinkColumn HeaderText="" DataNavigateUrlFields="ID" DataNavigateUrlFormatString="../Consultorio/Medicina.aspx?IdHist={0}"
