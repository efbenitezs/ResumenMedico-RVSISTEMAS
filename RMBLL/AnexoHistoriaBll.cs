      ...
      string nombreUsuarioTestigo)
        {
            try
            {
                ...
                cellTitle.BorderColor = new BaseColor(System.Drawing.Color.Transparent);
                cellTitle.HorizontalAlignment = 1; //0=Left 1=Center 2=Right
                ...
                cellParr1.Border = Rectangle.NO_BORDER;
                cellParr1.BorderColor = new BaseColor(System.Drawing.Color.Transparent);
                ...
                cellParr2.Border = Rectangle.NO_BORDER;
                cellParr2.BorderColor = new BaseColor(System.Drawing.Color.Transparent);
                ...
                cellBorder.Border = Rectangle.BOX;
                cellBorder.BorderWidth = 1;
                cellBorder.BorderColor = new BaseColor(System.Drawing.Color.Black);
                ...
                cellBorder2.Border = Rectangle.BOX;
                cellBorder2.BorderWidth = 1;
                cellBorder2.BorderColor = new BaseColor(System.Drawing.Color.Black);

                PdfPTable tableNotice = new PdfPTable(1);
                tableNotice.WidthPercentage = 100;
                ...
                cellBorder3.Border = Rectangle.NO_BORDER;
                /*
                ...
                */
                ...
                celLstNamePac.Border = Rectangle.BOX;
                celLstNamePac.BorderWidth = 1;
                celLstNamePac.BorderColor = new BaseColor(System.Drawing.Color.Black);
                celLstNamePac.Colspan = 2;

                tableFirmas.AddCell(celLstNamePac);


                PdfPCell cellNomPac = new PdfPCell(new Phrase(objEntPac.Nombres, fuenteNorm));
                cellNomPac.Border = Rectangle.BOX;
                cellNomPac.BorderWidth = 1;
                cellNomPac.BorderColor = new BaseColor(System.Drawing.Color.Black);
                cellNomPac.Colspan = 2;
                ...
                cellFechNacPac.Border = Rectangle.BOX;
                cellFechNacPac.BorderWidth = 1;
                cellFechNacPac.BorderColor = new BaseColor(System.Drawing.Color.Black);
                cellFechNacPac.Colspan = 2;
                tableFirmas.AddCell(cellFechNacPac);


                PdfPCell cellFirmaPac = new PdfPCell(new Phrase(" ", fuenteNorm));
                cellFirmaPac.Border = Rectangle.LEFT_BORDER;
                cellFirmaPac.BorderWidth = 1;
                cellFirmaPac.BorderColor = new BaseColor(System.Drawing.Color.Black);
                cellFirmaPac.HorizontalAlignment = 1;
                cellFirmaPac.Colspan = 4;
                tableFirmas.AddCell(cellFirmaPac);


                PdfPCell cellFecFirmaPac = new PdfPCell(new Phrase(" ", fuenteNorm));
                cellFecFirmaPac.Border = Rectangle.RIGHT_BORDER;
                cellFecFirmaPac.BorderWidth = 1;
                cellFecFirmaPac.BorderColor = new BaseColor(System.Drawing.Color.Black);
                cellFecFirmaPac.HorizontalAlignment = 1;
                cellFecFirmaPac.Colspan = 2;
                ...
                cellWitheSpc1.Border = Rectangle.LEFT_BORDER;
                cellWitheSpc1.BorderWidth = 1;
                cellWitheSpc1.BorderColor = new BaseColor(System.Drawing.Color.Black);
                cellWitheSpc1.HorizontalAlignment = 1;
                cellWitheSpc1.Colspan = 4;
                tableFirmas.AddCell(cellWitheSpc1);

                PdfPCell cellWitheSpc2 = new PdfPCell(new Phrase(" ", fuenteNorm));
                cellWitheSpc2.Border = Rectangle.RIGHT_BORDER;
                cellWitheSpc2.BorderWidth = 1;
                cellWitheSpc2.BorderColor = new BaseColor(System.Drawing.Color.Black);
                cellWitheSpc2.HorizontalAlignment = 1;
                cellWitheSpc2.Colspan = 2;
                tableFirmas.AddCell(cellWitheSpc2);

                PdfPCell celltxtSigCli = new PdfPCell(new Phrase("Signature of client", fuenteNorm));
                celltxtSigCli.Border = Rectangle.LEFT_BORDER;
                celltxtSigCli.BorderWidth = 1;
                celltxtSigCli.BorderColor = new BaseColor(System.Drawing.Color.Black);
                celltxtSigCli.HorizontalAlignment = 1;
                celltxtSigCli.Colspan = 4;
                tableFirmas.AddCell(celltxtSigCli);

                PdfPCell celltxtDateSig = new PdfPCell(new Phrase("Date (YYYY-MM-DD)", fuenteNorm));
                celltxtDateSig.Border = Rectangle.RIGHT_BORDER;
                celltxtDateSig.BorderWidth = 1;
                celltxtDateSig.BorderColor = new BaseColor(System.Drawing.Color.Black);
                celltxtDateSig.HorizontalAlignment = 1;
                celltxtDateSig.Colspan = 2;
                ...
                clTituloTutor.Border = Rectangle.BOX;
                clTituloTutor.BorderWidth = 1;
                clTituloTutor.BorderColor = new BaseColor(System.Drawing.Color.Black);
                clTituloTutor.HorizontalAlignment = 1;
                clTituloTutor.Colspan = 6;
                ...
                cltxtDeclBeh.Border = Rectangle.LEFT_BORDER;
                cltxtDeclBeh.BorderWidth = 1;
                cltxtDeclBeh.BorderColor = new BaseColor(System.Drawing.Color.Black);
                cltxtDeclBeh.HorizontalAlignment = 1;
                cltxtDeclBeh.Colspan = 3;
                tableFirmas.AddCell(cltxtDeclBeh);

                PdfPCell clBy = new PdfPCell(new Phrase("By:" + (isUnderAgePerson ? nombreTutor : ""), fuenteNorm));
                clBy.Border = Rectangle.RIGHT_BORDER;
                clBy.BorderWidth = 1;
                clBy.BorderColor = new BaseColor(System.Drawing.Color.Black);
                clBy.HorizontalAlignment = 1;
                clBy.Colspan = 3;
                tableFirmas.AddCell(clBy);

                PdfPCell clWhiteSpace3 = new PdfPCell(new Phrase(" ", fuenteNorm));
                clWhiteSpace3.Border = Rectangle.LEFT_BORDER;
                clWhiteSpace3.BorderWidth = 1;
                clWhiteSpace3.BorderColor = new BaseColor(System.Drawing.Color.Black);
                clWhiteSpace3.HorizontalAlignment = 1;
                clWhiteSpace3.Colspan = 4;
                tableFirmas.AddCell(clWhiteSpace3);

                PdfPCell clWhiteSpace4 = new PdfPCell(new Phrase(" ", fuenteNorm));

                clWhiteSpace4.Border = Rectangle.RIGHT_BORDER;
                clWhiteSpace4.BorderWidth = 1;
                clWhiteSpace4.BorderColor = new BaseColor(System.Drawing.Color.Black);
                clWhiteSpace4.HorizontalAlignment = 1;
                clWhiteSpace4.Colspan = 2;
                ...
                clTblSignWit1.Border = Rectangle.NO_BORDER;
                ...
                clTblSignFechFirm.Border = Rectangle.NO_BORDER;
                ...
                cltblsigDate.Border = Rectangle.NO_BORDER;
                ...
                cellFinal.Border = Rectangle.BOX;
                cellFinal.BorderColor = new BaseColor(System.Drawing.Color.Black);
                cellFinal.BorderWidth = 1;
      ...
      string pathLogos)
        {
            try
            {
                ...
                parrafoTexto1.Add(new Phrase("Client declaration\n", fuente));

                parrafoTexto1.Add(new Phrase("I, " + nombreComPac + ", declare that the information that I have provided in terms of my medical history and during my immigration health examinations as recorded in eMedical "
                                        + "is true and correct.\n", fuenteNorm));

                parrafoTexto1.Add(new Phrase("I understand that:\n\n", fuenteNorm));

                parrafoTexto1.Add(new Phrase("• my personal details and health information are being collected in the eMedical system to enable to the Department of Immigration and Border Protection (DIBP) officers to determine whether or not they are "
                                         + "satisfied that I meet the health criteria for an Australia visa(s);\n\n", fuenteNorm));

                parrafoTexto1.Add(new Phrase("• DIBP can collect and use personal and sensitive information entered into eMedical in accordance with the PrivacyAct 1988 (the Privacy Act);\n\n", fuenteNorm));

                parrafoTexto1.Add(new Phrase("• as required health examinations must be completed and assessed prior to a visa decision being made, if the information I have provided is not stored within the eMedical System, the processing of my visa "
                ...
                parrafoTexto1.Add(new Phrase("• if I have provided any false or misleading information to DIBP as part of my immigration health examination, my visa application(s) may be refused and/or any visa subsequently issued cancelled;\n\n", fuenteNorm));

                parrafoTexto1.Add(new Phrase("• DIBP has a privacy policy that contains information about how I can access the information stored in eMedical,seek the correction of such information, complain about a breach of any Australian privacy "
                ...
                parrafoTexto1.Add(new Phrase("• a DIBP privacy notice is available at: http://www.border.gov.au/forms/Documents/1442i.pdf. Important information about the collection, use and disclosure (to other agencies and third parties, "
                                            + "including overseas entities) of your personal information, including sensitive information, is contained in this notice.\n\n", fuenteNorm));

                parrafoTexto1.Add(new Phrase("• further information about eMedical and arrangements in place to protect your personal information where stored in eMedical is available on the DIBP website at "
                                            + "http://www.border.gov.au/Trav/Visa/Heal/Meeting-the-health-requirement/electronic-health-processing;" + " and\n\n", fuenteNorm));

                parrafoTexto1.Add(new Phrase("• DIBP's contact details are outlined on its website at: http://www.border.gov.au/Lega/Lega/Help/help \n\n", fuenteNorm));
                objDoc.Add(parrafoTexto1);

                Paragraph parrafoTexto2 = new Paragraph();

                parrafoTexto2.Add(new Phrase("In accordance with the Privacy Act, I consent to:\n", fuenteNorm));
                parrafoTexto2.Add(new Phrase("•	my personal and sensitive information (such as my medical information) being collected and stored in the eMedical system that is hosted by DIBP, and automatically submitted to DIBP for the "
                                    + "purposes of assessing my health for current or future Australian visa applications;\n\n", fuenteNorm));

                parrafoTexto2.Add(new Phrase("•	DIBP storing my digital photograph(s) which may be used by DIBP for client identification purposes in addition to the health examination process;\n\n", fuenteNorm));

                parrafoTexto2.Add(new Phrase("•	DIBP retaining my medical information, including any x-ray images uploaded to eMedical, beyond the finalisation of my visa application, for the purposes of considering future applications "
                                    + "I may make for a visa to Australia;\n\n", fuenteNorm));

                parrafoTexto2.Add(new Phrase("•	the Commonwealth of Australia becoming the owner of the information entered into eMedical and that this information will be passed to DIBP;\n\n", fuenteNorm));

                parrafoTexto2.Add(new Phrase("•	DIBP may destroy my personal data (including digital x-ray images and photographs) stored in eMedical after a certain period of time where consistent with DIBP’s archiving obligations and "
                ...
                parrafoTexto2.Add(new Phrase("•	DIBP disclosing my personal information, including information about my health and any complaint I may lodge, to the radiologists/panel doctors and clinic administrative staff. The reasons for "
                                    + "this disclosure will be to investigate and resolve inconsistencies, complaints or audit recommendations; and\n\n", fuenteNorm));

                parrafoTexto2.Add(new Phrase("•	my personal information (including my sensitive information) stored in eMedical (including medical results, biodetails and digital photographs) to be disclosed to:\n", fuenteNorm));

                parrafoTexto2.Add(new Phrase(" −	Australian Government health agencies, the Department of Social Services for the purposes of administering and delivering Humanitarian Settlement Services (HSS) support to me, health and settlement "
                ...
                parrafoTexto2.Add(new Phrase(" −	Australian Government agencies authorised to receive information relating to adoption, border control, business skills, citizenship, education, health assessment, health insurance, health services, "
                ...
                parrafoTexto2.Add(new Phrase(" −	Australian law enforcement, health agencies and international agencies, including overseas recipients in the United Kingdom, the United States of America, Canada and New Zealand, for the purposes of "
